...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        Returns:
            Rectangle: instance of a rectangle

        Raises:
            TypeError: if parrameters are not instances of a Rectangle
        """
    ...
    def square(cls, size = 0):
        """A class method hat returns a new Rectangle instance with width == height == size
        
        Args:
            size (int): The size of the square

        Returns:
            Rectangle: An instance of a rectangle
        """
