...
class TestRectangle_instantiation(unittest.TestCase):
    """Class defining the Rectangle instantiation unittest cases"""
    ...
    def test_with_more_then_five_args(self):
        with self.assertRaises(TypeError):
            Rectangle(10, 2, 4, 5, 20, 5)

class TestRectangle_width(unittest.TestCase):
    """Class testing Rectangle width"""
    ...
    def test_integer_below_zero(self):
...
class TestRectangle_height(unittest.TestCase):
    """Class testing Rectangle height"""
...
class TestRectangle_y(unittest.TestCase):
    """Class testing Rectangle y"""

    def test_str(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            Rectangle(4, 4, 4, "hello")
    ...
    def test_zero(self):
        r1 = Rectangle(12, 3, 4, 0)
        self.assertEqual(r1.y, 0)

    def test_integer(self):
        r1 = Rectangle(12, 2, 4, 2)
